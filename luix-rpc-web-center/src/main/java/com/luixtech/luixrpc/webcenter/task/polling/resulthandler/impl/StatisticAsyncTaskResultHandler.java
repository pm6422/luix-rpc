package com.luixtech.luixrpc.webcenter.task.polling.resulthandler.impl;

import com.luixtech.luixrpc.webcenter.dto.StatisticDTO;
import com.luixtech.luixrpc.webcenter.task.polling.AsyncTask;
import com.luixtech.luixrpc.webcenter.task.polling.queue.InMemoryAsyncTaskQueue;
import com.luixtech.luixrpc.webcenter.task.polling.queue.StatisticResultHolder;
import com.luixtech.luixrpc.webcenter.task.polling.resulthandler.AsyncTaskResultHandler;
