...
//import com.luixtech.luixrpc.core.listener.client.ConsumerListener;
//import com.luixtech.luixrpc.core.listener.server.ProviderListener;
//import com.luixtech.luixrpc.core.url.Url;
//import com.luixtech.luixrpc.registry.zookeeper.service.TestDummyService;
//import com.luixtech.luixrpc.registry.zookeeper.utils.ZookeeperUtils;
//import com.luixtech.luixrpc.utilities.annotation.EventMarker;
...
//import java.util.*;
//
//import static com.luixtech.luixrpc.core.constant.ProtocolConstants.PROTOCOL_VAL_LUIX;
//import static com.luixtech.luixrpc.core.constant.RegistryConstants.REGISTRY_VAL_ZOOKEEPER;
//import static com.luixtech.luixrpc.registry.zookeeper.utils.ZookeeperUtils.FULL_PATH_COMMAND;
...
//        List<Url> activeProviderUrls = registry.discoverProviders(consumerUrl);
//        assertTrue(activeProviderUrls.isEmpty());
//
//        registry.doActivate(providerUrl1);
//        registry.doActivate(providerUrl2);
//        activeProviderUrls = registry.discoverProviders(consumerUrl);
...
//            }
//        };
//        registry.subscribeListener(consumerUrl, providerListener);
