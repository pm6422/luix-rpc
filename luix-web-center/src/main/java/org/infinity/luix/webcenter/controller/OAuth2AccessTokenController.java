...
import org.infinity.luix.webcenter.repository.OAuth2AccessTokenRepository;
import org.infinity.luix.webcenter.utils.HttpHeaderUtils;
import org.infinity.luix.webcenter.domain.Authority;
import org.infinity.luix.webcenter.domain.MongoOAuth2AccessToken;
...
public class OAuth2AccessTokenController {
    ...
    public ResponseEntity<List<MongoOAuth2AccessToken>> find(Pageable pageable,
        ...
        HttpHeaders headers = HttpHeaderUtils.generatePageHeaders(tokens);
