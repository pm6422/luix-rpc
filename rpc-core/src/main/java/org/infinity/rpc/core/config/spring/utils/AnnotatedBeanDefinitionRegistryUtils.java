...
public abstract class AnnotatedBeanDefinitionRegistryUtils {
    ...
    public static boolean isPresentBean(BeanDefinitionRegistry registry, Class<?> annotatedClass) {
        ...
        for (String beanName : beanNames) {
            ...
            if (beanDefinition instanceof AnnotatedBeanDefinition) {
                ...
                if (present) {
                        log.debug(format("The annotatedClass[class : %s , bean name : %s] was present in registry[%s]",
    ...
    public static void registerBeans(BeanDefinitionRegistry registry, Class<?>... annotatedClasses) {
        ...
        if (log.isDebugEnabled()) {
            log.debug(registry.getClass().getSimpleName() + " will register annotated classes : " + asList(annotatedClasses) + " .");
        }
