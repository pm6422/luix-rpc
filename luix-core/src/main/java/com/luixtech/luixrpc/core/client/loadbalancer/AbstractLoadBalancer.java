package com.luixtech.luixrpc.core.client.loadbalancer;
...
import static com.luixtech.luixrpc.core.thread.ScheduledThreadPool.DESTROY_SENDER_DELAY;
import static com.luixtech.luixrpc.core.thread.ScheduledThreadPool.DESTROY_SENDER_THREAD_POOL;
...
public abstract class AbstractLoadBalancer implements LoadBalancer {
    ...
    public List<Sendable> selectAllActiveSenders(Requestable request) {
        if (CollectionUtils.isEmpty(this.requestSenders)) {
            throw new RpcInvocationException("No active RPC request sender for "
