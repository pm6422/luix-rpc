...
import static org.infinity.luix.utilities.statistics.StatisticsUtils.getMemoryStatistic;
...
//        return ChannelState.UNINITIALIZED.equals(client.getState()) || client.isClosed();
    ...
    public void addEndpoint(Endpoint endpoint) {
        ...
        String heartbeatFactoryName = providerUrl.getOption(ProviderConstants.HEALTH_CHECKER, ProviderConstants.HEALTH_CHECKER_VAL_DEFAULT);
