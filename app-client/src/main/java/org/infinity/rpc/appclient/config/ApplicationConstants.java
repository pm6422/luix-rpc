...
public final class ApplicationConstants {
    ...
    public static final  String   BASE_PACKAGE                  = "org.infinity.rpc.appclient";
    // Spring profile
    ...
    public static final  String[] AVAILABLE_PROFILES            = new String[]{SPRING_PROFILE_NO_SWAGGER, SPRING_PROFILE_NO_AOP_LOGGING, SPRING_PROFILE_TEST, SPRING_PROFILE_PRODUCTION};
