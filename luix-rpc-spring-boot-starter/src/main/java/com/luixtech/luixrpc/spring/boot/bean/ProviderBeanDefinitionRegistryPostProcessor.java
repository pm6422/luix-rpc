package com.luixtech.luixrpc.spring.boot.bean;

import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang3.StringUtils;
import com.luixtech.luixrpc.core.config.impl.ProtocolConfig;
import com.luixtech.luixrpc.core.config.impl.ProviderConfig;
import com.luixtech.luixrpc.core.server.annotation.RpcProvider;
import com.luixtech.luixrpc.core.server.stub.ProviderStub;
import com.luixtech.luixrpc.spring.boot.bean.name.DefaultBeanNameGenerator;
import com.luixtech.luixrpc.spring.boot.bean.registry.ClassPathBeanDefinitionRegistryScanner;
import com.luixtech.luixrpc.spring.boot.utils.AnnotationUtils;
...
import static com.luixtech.luixrpc.core.constant.ProtocolConstants.PROTOCOL;
import static com.luixtech.luixrpc.core.constant.ProtocolConstants.SERIALIZER;
import static com.luixtech.luixrpc.core.constant.ProviderConstants.HEALTH_CHECKER;
import static com.luixtech.luixrpc.core.constant.ServiceConstants.*;
import static com.luixtech.luixrpc.core.server.stub.ProviderStub.buildProviderStubBeanName;
import static com.luixtech.luixrpc.spring.boot.config.LuixProperties.readProtocolConfig;
import static com.luixtech.luixrpc.spring.boot.config.LuixProperties.readProviderConfig;
import static com.luixtech.luixrpc.spring.boot.utils.AnnotationBeanDefinitionUtils.addPropertyReference;
import static com.luixtech.luixrpc.spring.boot.utils.AnnotationBeanDefinitionUtils.addPropertyValue;
